      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
        ...
        <section>
          <div className="flex justify-between items-center mb-4">
            ...
            <button 
                onClick={() => setConfig(prev => ({...prev, alphaAttraction: 0.75, betaAttraction: -0.42}))}
            ...
            <div className="bg-white/5 p-4 rounded-xl border border-white/5 hover:border-white/10 transition-colors">
              <div className="flex justify-between items-center mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="material-icons-round text-gray-500 text-xs">arrow_forward</span>
        ...
        <section>
          <h3 className="text-sm font-medium text-gray-200 uppercase tracking-wider mb-4">Population Trends</h3>
             ...
             <div className="w-full h-full relative z-10">
                <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={mockData}>
                        ...
                        <Area type="monotone" dataKey="alpha" stroke="#f472b6" strokeWidth={2} fillOpacity={1} fill="url(#colorAlpha)" />
                        <Area type="monotone" dataKey="beta" stroke="#22d3ee" strokeWidth={2} fillOpacity={1} fill="url(#colorBeta)" />
